...
Currently, the only thing you can actually /do/ in the =*Beeminder
goal details*= buffer is to quit it by pressing =q=.  It is planned to
be able to edit or delete datapoints from here.
